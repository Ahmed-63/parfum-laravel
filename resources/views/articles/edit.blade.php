<x-app-layout>
  ...
  />
    ...
    <div class="p-4 md:w-1/3 flex justify-center">
        ...
        <form action="{{ route('articles.store') }}" method="article" enctype="multipart/form-data" class="flex flex-col  rounded-lg p-4" style="background-color: rgba(0, 0, 0, 0.075); border: 2px solid rgba(0, 0, 0, 0.048);"> 
